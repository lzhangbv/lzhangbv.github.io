...
I am broadly interested in machine learning systems and applications, with a special focus on: 1) distributed training, 2) second-order optimization, and 3) learning on graphs. I am on the job market. 
...
* Barakeel Fanseu Kamhoua, **Lin Zhang+**, Yongqiang Chen, Han Yang, Kaili Ma, Bo Han, Bo Li, and James Cheng, “Exact Shape Correspondence via 2D graph convolution”, in the Conference on Neural Information Processing Systems (NeurIPS), 2022. <font color="red">Spotlight</font>. \[[PDF](https://openreview.net/pdf?id=f39vsgpEaY5), [Code](https://github.com/BarakeelFanseu/2D-GEM)\]
